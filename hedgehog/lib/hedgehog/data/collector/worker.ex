defmodule Hedgehog.Data.Collector.Worker do
  ...
  def start_link(topic) do
    GenServer.start_link(
      __MODULE__,
      topic,
      name: {:via, Registry, {:collector_workers, topic}}
    )
  end

  def init(topic) do
    Logger.info("Collector worker is subscribing to topic #{topic}")

    Phoenix.PubSub.subscribe(Hedgehog.PubSub, topic)
  ...
  def handle_info(%TradeEvent{} = trade_event, state) do
    ...
    struct!(TradeEvent, opts) |> Repo.insert()
